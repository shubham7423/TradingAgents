...
def build_market_prompt(state: Mapping[str, Any], *, output_language: str) -> str:
    """Build the complete market analyst system message without I/O.
...
Write a very detailed and nuanced report of the trends you observe. Provide specific, actionable insights with supporting evidence to help traders make informed decisions."""
    ...
    return (
        ...
        " You have access to the following tools: get_stock_data, get_indicators, get_verified_market_snapshot."
